...
export const quizEditorTutorial: Tutorial = {
  ...
  steps: [
    ...
    },
    {
      id: 'sidebar',
      title: 'Adding Slides',
      content: 'Use the sidebar to add new slides to your quiz. Click the "Add Slide" button to get started.',
    ...
    },
    {
      ...
      content: 'Select "Info Slide" to create your first slide. Info slides are great for introducing topics or providing context.',
    ...
    },
    {
      id: 'editor',
      title: 'Slide Editor',
      content: 'This is where you can edit your slide content. Try adding some text or images!',
...
export const questionSlideTutorial: Tutorial = {
  ...
  steps: [
    ...
    },
    {
      ...
      content: 'Choose from different question types like Multiple Choice, True/False, or Open Ended.',
    ...
    },
    {
      ...
      content: 'Configure time limits, points, and other question-specific settings here.',
...
export const allTutorials = [quizManagerTutorial, quizEditorTutorial, questionSlideTutorial]; 