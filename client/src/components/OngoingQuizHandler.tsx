...
export default function OngoingQuizHandler() {
  const {
    ongoingQuizzes: { resources, isLoading, endQuiz },
  } = useAppContext();
  ...
  return (
    <div className="absolute right-0 top-1/2">
      <div className="mr-6 bg-card rounded p-4 text-foreground flex flex-col border shadow gap-2">
        <span className="text-xs text-muted-foreground">
          There is an ongoing quiz: {ongoingQuiz.id}
        </span>
